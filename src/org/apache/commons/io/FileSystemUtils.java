...
public class FileSystemUtils {
	 ...
	 * Windows, 512 byte units on OS X and kilobytes on Unix. As this is not
	 * very useful, this method is deprecated in favour of
	 * {@link #freeSpaceKb(String)} which returns a result in kilobytes.
	 * <p>
