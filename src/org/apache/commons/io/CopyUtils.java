...
/**
 * This class provides static utility methods for buffered copying between
 ...
 * <code>Writer</code>, <code>String</code> and <code>byte[]</code>).
 * <p>
 ...
 * be selected (otherwise the platform default is used). We would like to
 * encourage you to always specify the encoding because relying on the platform
 * default can lead to unexpected results.
 * <p
 * We don't provide special variants for the <code>copy</code> methods that let
 * you specify the buffer size because in modern VMs the impact on speed seems
 * to be minimal. We're using a default buffer size of 4 KB.
 * <p>
 ...
 * variants to specify the encoding, each row may correspond to up to 2 methods.
 * <p>
 ...
 * @deprecated Use IOUtils. Will be removed in 2.0. Methods renamed to
 *             IOUtils.write() or IOUtils.copy(). Null handling behaviour
 *             changed in IOUtils (null data does not throw
